...
# The last entry of "application/shalom" is bogus, and is there only so you can test that Fastly actually uses these settings. 


table ContentTypes {
		"0123"   :   "application/vnd.lotus-1-2-3",
